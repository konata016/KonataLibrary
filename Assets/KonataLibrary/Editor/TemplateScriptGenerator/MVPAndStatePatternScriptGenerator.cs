...
public class MVPAndStatePatternScriptGenerator : ScriptGeneratorBase
{
    ...
    private static readonly string templateScriptPath = $"{EditorPathDefine.TemplateScriptFolderPath}/MvpAndState";
    private static readonly string scriptSaveFolderPath = EditorPathDefine.ScriptSaveFolderPath;

    private static readonly string templateScriptPresenterName = "TEMPLATE_SCRIPT_STATE_PATTERN_PRESENTER";
    private static readonly string templateScriptViewName = "TEMPLATE_SCRIPT_STATE_PATTERN_VIEW";
    private static readonly string templateScriptModelName = "TEMPLATE_SCRIPT_STATE_PATTERN_MODEL";
    private static readonly string templateScriptStateName = "TEMPLATE_SCRIPT_STATE_TEMP";
    private static readonly string templateScriptStateBaseName = "TEMPLATE_SCRIPT_STATE_BASE";
    private static readonly string templateScriptStateInfoName = "TEMPLATE_SCRIPT_STATE_INFO";
    ...
    public MVPAndStatePatternScriptGenerator()
    {
        SetupPullDownLabel();
